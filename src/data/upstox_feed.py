"""Upstox data feed adapter — Phase 0 stub.

All methods raise NotImplementedError. The Upstox SDK is imported lazily
inside each method so importing this module does not load the SDK.
"""
...
class UpstoxFeed(BaseFeed):
    ...
    def connect(self) -> bool:
        # TODO: Phase 1 — import upstox_client, build configuration, verify token
